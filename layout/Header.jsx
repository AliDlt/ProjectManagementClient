...
function Header() {
  ...
  return (
    <header className=" sticky top-0 lg:col-span-9 2xl:col-span-10 rounded-br-custom rounded-bl-custom lg:rounded-custom shadow-custom border-b-4 border-custom-primary-color/50 lg:top-5 bg-white z-30">
